...
export default function NeonShield({ className = "", size = 280 }: { className?: string; size?: number }) {
  ...
  return (
    <svg
      ...
      className={cn("drop-shadow-[0_0_30px_rgba(0,194,255,0.45)]", className)}
      role="img"
    ...
    >
      <defs>
        ...
        <radialGradient id="glow" cx="50%" cy="50%" r="60%">
          ...
          <stop offset="55%" stopColor="#00C2FF" stopOpacity="0.18" />
      ...
      <g>
        ...
        <g transform="translate(100,115)">
          <path d="M0 -38 L22 26 L10 26 L6 15 L-6 15 L-10 26 L-22 26 Z M0 -6 L-2 0 L2 0 Z" fill="#0b0f14" opacity="0.9" />
          <path d="M0 -38 L22 26 L10 26 L6 15 L-6 15 L-10 26 L-22 26 Z M0 -6 L-2 0 L2 0 Z" fill="none" stroke="url(#g1)" strokeWidth="2" />
        </g>
        <circle cx="100" cy="120" r="88" fill="none" stroke="rgba(0,194,255,0.35)" strokeWidth="2" />
      </g>
    </svg>
  )
}
